...
class _DetailedPageState extends State<DetailedPage> {
  ...
  getDate(tm, tm1) async {
    ...
    var dt1 = jsonDecode(jsonEncode(ds1.data()));
    ...
    if(ds.exists){
      ...
      FirebaseFirestore.instance.collection('rental').doc(id).snapshots().listen((event) {
        ...
        if(type == 'Shoes'){
          setState(() {
            ...
            s = dt1['shoes_s'] - dt['shoes_reg_s'].length;
            m = dt1['shoes_m'] - dt['shoes_reg_m'].length;
            l = dt1['shoes_l'] - dt['shoes_reg_l'].length;
            s < 0?s = 0:s = s;
            m < 0?m = 0:m = m;
            l < 0?l = 0:l = l;
          });
        ...
        if(type == 'Jersey'){
          setState(() {
            // var dt = jsonDecode(jsonEncode(ds.data()));
            s = dt1['jersey_s'] - dt['jersey_reg_s'].length;
            m = dt1['jersey_m'] - dt['jersey_reg_m'].length;
            l = dt1['jersey_l'] - dt['jersey_reg_l'].length;
            s < 0?s = 0:s = s;
            m < 0?m = 0:m = m;
            l < 0?l = 0:l = l;
          });
      ...
      print(dt1);
      var items = {
        'shoes_total_s': dt1['shoes_s'],
        'shoes_reg_s': [],
        'shoes_total_m': dt1['shoes_m'],
        'shoes_reg_m': [],
        'shoes_total_l': dt1['shoes_l'],
        'shoes_reg_l': [],
        'jersey_total_s': dt1['jersey_s'],
        'jersey_reg_s': [],
        'jersey_total_m': dt1['jersey_m'],
        'jersey_reg_m': [],
        'jersey_total_l': dt1['jersey_l'],
        'jersey_reg_l': [],
        'id': id,
        'date': i,
        'time': tm1,
