                        ...
                        RaisedButton(
                            ...
                            onPressed: () async {
                              ...
                              if(service == 'rental'){
                                ...
                                dtt = await collectionsReference1.doc(list['id'].toString()).get();
                              }
                              if(service == 'tournament'){
                                collectionsReference1 =
                                    FirebaseFirestore.instance.collection('tournament');
                                dtt = await collectionsReference1.doc(list['tournament_id'].toString()).get();
                              }
                              ...
                              if (await confirm(
                                ...
                                return {
                                  if(service == 'rental'){
                                    if(list['category'] == 'Shoes'){
                                      s = dtt['shoes_reg_s'],
                                      m = dtt['shoes_reg_m'],
                                      l = dtt['shoes_reg_l'],
                                      s = s.skip(list['no_of_s_Shoes']).toList(),
                                      m = m.skip(list['no_of_m_Shoes']).toList(),
                                      l = l.skip(list['no_of_l_Shoes']).toList(),
                                      print('aaaaaaaaaaaaaaaaaaaaaaaaa'),
                                      print(s),
                                      print(m),
                                      print(l),
                                      collectionsReference1.doc(list['id'].toString()).update(
                                          {
                                            "shoes_reg_s": s,
                                            "shoes_reg_m": m,
                                            "shoes_reg_l": l,
                                    ...
                                    if(list['category'] == 'Jersey'){
                                      s = dtt['jersey_reg_s'],
                                      m = dtt['jersey_reg_m'],
                                      l = dtt['jersey_reg_l'],
                                      s = s.skip(list['no_of_s_Jersey']).toList(),
                                      m = m.skip(list['no_of_m_Jersey']).toList(),
                                      l = l.skip(list['no_of_l_Jersey']).toList(),
                                  ...
                                  if(service == 'tournament'){
                                    ...
                                    s = s.skip(1).toList(),
                                    print(s),
                                    collectionsReference1.doc(list['tournament_id'].toString()).update(
                                        {
                                          "registered": s,
                                        }),
                                  },
